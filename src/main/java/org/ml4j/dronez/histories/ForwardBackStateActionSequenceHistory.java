 ...
 *
 */
public class ForwardBackStateActionSequenceHistory extends StateActionSequenceHistory<PositionVelocityWithRecentActions<ForwardBackAction>, PositionVelocityWithRecentActions<ForwardBackAction>, ForwardBackAction> {

	private static final long serialVersionUID = 1L;
	
	public ForwardBackStateActionSequenceHistory(StateActionSequenceHistory<DroneStateWithRecentActions,DroneStateWithRecentActions,DroneAction> history)
	{
		int iteration = 0;
		...
		{
			onStateActionStateSequence(iteration++, data.getData().getState().getForwardBackPositionVelocity(), data.getData().getAction().getForwardBackAction(), data.getLabel().getForwardBackPositionVelocity());
		}
	}
