...
public class TargetRelativeModelLearningApplication<S extends Serializable,T extends Serializable,A extends Serializable> {
	...
	public static void main(String[] args)
	{
		...
		serializationHelper.serialize(distanceToTargetPositionLeftRightModel, "distanceToTargetPositionLeftRightModel_19032015_6");
		serializationHelper.serialize(distanceToTargetPositionUpDownModel, "distanceToTargetPositionUpDownModel_19032015_6");
		serializationHelper.serialize(distanceToTargetPositionForwardBackModel, "distanceToTargetPositionForwardBackModel_19032015_6");
		serializationHelper.serialize(distanceToTargetPositionSpinModel, "distanceToTargetPositionSpinModel_19032015_6");
