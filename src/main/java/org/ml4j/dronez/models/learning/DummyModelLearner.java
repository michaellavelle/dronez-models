...
/**
 * Dummy ModelLearner which simply returns a static DummyDroneModel
 * 
 * @author Michael Lavelle
 *
 */
public class DummyModelLearner implements ModelLearner<DroneStateWithRecentActions, DroneStateWithRecentActions, DroneAction> {
